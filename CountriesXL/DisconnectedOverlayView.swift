            ...
            VStack(spacing: 18) {
                ...
                if let details = details, !details.isEmpty {
                    DisclosureGroup(isExpanded: $revealDetails) {
                        ...
                        Text(LocalizedStringKey("disconnected.details"))
                            .font(.callout)
                            .foregroundStyle(.secondary)
                    }
                    .padding(.horizontal)
...
#Preview {
    DisconnectedOverlayView(
        title: NSLocalizedString("disconnected.title", comment: "No internet title"),
        message: NSLocalizedString("disconnected.message", comment: "Disconnected message"),
        details: NSLocalizedString("disconnected.preview_details", comment: "Preview details"),
        primaryActionTitle: NSLocalizedString("disconnected.tryAgain", comment: "Primary action"),
        primaryAction: {},
        secondaryActionTitle: NSLocalizedString("disconnected.close", comment: "Secondary action"),
        secondaryAction: {},
        brandingImage: Image(systemName: "globe"),
        tertiaryActionTitle: NSLocalizedString("disconnected.diagnostics", comment: "Tertiary action"),
        tertiaryAction: {},
        brandingSize: 140,
        brandingPlate: true,
        cardCornerRadius: 24,
